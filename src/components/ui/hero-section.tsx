...
export default function HeroSection() {
  ...
  return (
    <>
      ...
      <section className="relative w-full bg-[#F8FAFC] text-sm pb-44 overflow-hidden">
        {/* Grid Background Effect */}
        <div 
          className="absolute inset-0 bg-[url('https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/hero/gridBackground.png')] bg-no-repeat bg-cover bg-center opacity-[0.1] pointer-events-none" 
        ...
        <motion.div
          ...
          className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,_rgba(109,40,217,0.1)_0%,_transparent_70%)] pointer-events-none"
        />
        ...
        <div className="relative z-10 flex items-center gap-2 border border-slate-300 hover:border-slate-400/70 rounded-full w-max mx-auto px-4 py-2 mt-40 md:mt-32">
        ...
        <div className="relative z-10 mx-auto w-full flex items-center justify-center gap-3 mt-4">
          ...
          <button className="flex items-center gap-2 border border-slate-300 hover:bg-slate-200/30 rounded-full px-6 py-3">
            ...
            <ChevronRight className="w-4 h-4 text-[#050040] opacity-40" />
          </button>
        </div>
      </section>
    </>
